...
const Home = () => {
  ...
  //seting active students array index
  const [activeStudentIndex, setActiveStudentIndex] = useState(0);
  //seting active students user id
  const [activeStudentUserId, setActiveStudentUserId] = useState(0);

  useEffect(() => {
    //const allBlinkers=JSON.parse(localStorage.getItem("guardianBlinkers"));
    setActiveStudentIndex(localStorage.getItem("activeBlinkerIndex"));
    setActiveStudentUserId(localStorage.getItem("activeBlinker"));
    //alert("The user Id Mounted to the state hook is: "+activeStudentUserId)

    const activeBlinkerIndexNum = localStorage.getItem("activeBlinkerIndex");
    const activeBlinkerUserIdNum = localStorage.getItem("activeBlinker");

    //alert("The index Num is :"+activeBlinkerIndexNum+"the user Id is "+activeBlinkerUserIdNum)

    console.log(allMyChildren.length);
    const allBlinkers = AuthService.getLogedInAssociates();
    const activeIndexer = parseInt(AuthService.ActiveBlinkerIndex);

    setAllMyChildren(allBlinkers);

    setStudents(AuthService.getLogedInAssociates());
    setFirstStudent(allBlinkers[activeStudentIndex]);
    setMyBlinkersCount(allBlinkers.length);
    //console.log(allBlinkers[0])
    //console.log(AuthService.getLogedInAssociates)
    console.log("All Blinkers are :" + allMyChildren.length);
    console.log(allBlinkers);

    AuthService.getStudentDetails(allBlinkers[activeStudentIndex].userId)
      .then((res) => {
        ...
        setBlinkWalletAccountNum(
          res.data.data.userProfile.blinkaccounts.find(
            (x) => x.blinkersAccountType === "POCKECT_MONEY"
          ).accountNumber
        );
    ...
    console.log("The tranfsactions should appear down here as an object");

    alert(parseInt(localStorage.getItem("activeBlinker")));
    AuthService.getStudentTransactions(
      blinkWalletAccountNum,
      localStorage.getItem("activeBlinker")
    )
      .then((res) => {
        //alert(activeStudentUserId)
  ...
  const getInstitututionName = (studentId) => {
    ...
    AuthService.getStudentDetails(studentId).then((res) => {
      ...
      studentInstitutionName =
        res.data.data.associates[activeStudentIndex].cardId;
      //alert(schoolName);
  ...
  const blinkerClicked = (studentId, clickedIndex) => {
    // alert(clickedIndex)
    setActiveStudentIndex(clickedIndex);
    setActiveStudentUserId(studentId);
    //alert("clicked student Id is "+studentId)
    //alert("local storage student Index is "+localStorage.getItem("activeBlinkerIndex"))

    localStorage.setItem("activeBlinker", studentId);
    localStorage.setItem("activeBlinkerIndex", clickedIndex);

    //alert(localStorage.getItem("activeBlinker"))
    ...
    AuthService.getStudentDetails(studentId).then((res) => {
      ...
      AuthService.getStudentDetails(
        AuthService.getLogedInAssociates()[clickedIndex].userId
      )
        .then((res) => {
          setStudentProfile(res.data.data.userProfile);
                ...
                <div className="row">
                  <div className="col-lg-4 d-flex align-content-center">
                    <div className="dropdown d-inline-block w-100 d-flex align-items-center">
                      <button
                        type="button"
                        className="btn header-item waves-effect align-items-center w-100  text-left d-flex p-0"
                        id="blinkers-drop"
                      ...
                      >
                        <div className="flex-shrink-0 me-3">
                          <img
                            ...
                            src="assets/images/logo-files/blink-icon2.svg"
                            alt="Generic placeholder image"
                            height="65"
                          />
                          <div className="avatar-sm mx-auto ">
                            <span className="avatar-title rounded-circle bg-random font-size-20">
                              {studentProfile.institution != undefined &&
                                firstStudent.firstName.charAt(0) +
                                  "" +
                                  firstStudent.middleName.charAt(0)}
                            </span>
                          </div>
                        </div>

                        <div className="flex-grow-1 chat-user-box me-3">
                          <h6 className="user-title m-0 font-size-18">
                            {firstStudent?.firstName +
                              " " +
                              firstStudent?.middleName}
                          </h6>
                          <p className="text-muted m-0 p-0 font-size-12">
                            {firstStudent?.blinkId}
                          </p>
                        </div>
                        {StdFunctions.isBlinkersMore(students.length) ? (
                          <div className="d-flex justify-content-center align-items-center">
                            <span>
                              <i className="mdi mdi-chevron-down  d-xl-inline-block me-3 font-21"></i>
                            </span>
                          </div>
                        ) : (
                          <span></span>
                        ...
                        {students.length > 1 &&
                          students.map((item, index) => (
                            <div style={{ maxheight: "230px" }}>
                              <a
                                onClick={() =>
                                  blinkerClicked(item.userId, index)
                                }
                                className="d-flex px-3 pb-2 waves-effect dropdown-item"
                              >
                                <div className="flex-shrink-0 me-3">
                                  <img
                                    className="rounded-circle d-none"
                          ...
                          <div className="dropdown">
                            ...
                            <div className="dropdown-menu dropdown-menu-start">
                              <a className="dropdown-item" href="#">
                                <i className="font-size-15 mdi mdi-shield-account me-3"></i>
                                View Account
                              </a>
                              <a className="dropdown-item" href="#">
                                <i className="font-size-15 mdi mdi-clipboard-text me-3"></i>
                                Tasks
                              </a>
                              <a className="dropdown-item text-danger" href="#">
                                <i className="font-size-15 mdi mdi-lock-remove me-3"></i>
                                Block Account
                              </a>
                            </div>
                          </div>
                ...
                <div className="card bg-primary bg-primary-blink blink-card-bg">
                  <div className="card-body blink-car">
                    <div className="d-flex justify-content-between align-items-center mb-2">
                      <div className="flex-shrink-0 align-self-center mb-3">
                        <img
                          ...
                          className="avatar-md rounded-circle img-thumbnail d-none"
                          alt=""
                        />
                    ...
                    <div className="d-flex align-content-center align-items-center mb-3">
                      <div className="flex-grow-1">
                        ...
                        <h4 className="font-size-15 mb-0 text-white text-capitalize">
                          {studentProfile.institution != undefined &&
                      ...
                      <div className="flex-grow-1 text-right">
                        ...
                        <h5 className="font-size-15 mb-0 text-white">
                          {studentProfile.institution != undefined &&
                            studentProfile.institution.institutionName}
                        </h5>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-6">
                        <div className="d-flex align-items-center">
                          <span className="badge  badge-soft-light font-size-12">
                            {" "}
                            KES 50{" "}
                          </span>{" "}
                          <span className="ms-2 mb-0 pb-0 text-truncate text-white">
                            Used Today
                          </span>
                        </div>
                      </div>
                      <div className="col-6 d-flex align-items-end justify-content-end text-right">
                        <span className="mt-0 mb-0 text-nowrap">
                          <span className="badge badge-soft-light font-size-11 me-2">
                            {" "}
                  ...
                  <div className="card-footer">
                    <div className="text-white">
                      <p className="text-white-50 text-truncate mb-0">
                        Wallet Balance.
                      </p>
                      <h3 className="text-white kenyan-carency">
                        {studentProfile.blinkaccounts != undefined &&
                          StdFunctions.kenyaCurrency(
                            studentProfile.blinkaccounts.find(
                              (x) => x.blinkersAccountType === "POCKECT_MONEY"
                            ).currentBalance
                          )}
                      </h3>
                  ...
                  <div className="card-body">
                    ...
                    <div className="row">
                      ...
                      <div className="col-6 d-flex align-items-end justify-content-end">
                        <p className="text-right mb-0 pb-0 text-white-50">
                          Blink ID: 1235 2659 2358
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card history-card">
                  <div className="card-header bg-white">
                    <h4 className="card-title mb-0 text-capitalize">
                      Recent Transactions for {firstStudent.firstName}
                    </h4>
                  </div>
                                ...
                                <tr>
                                  <th scope="row" className="px-sm-0">
                                    <div className="d-flex align-items-center">
                                      <div className="avatar-xs me-0">
                                        {StdFunctions.isDepositTransaction(
                                  ...
                                  <td>
                                    <div className="text-truncate text-capitalize product-items-trunc">
                                      ...
                                      <span className="product-items">
                                        {transaction.productsSold.length > 0 &&
                                          transaction.productsSold.map(
                                            (product, index) => (
                                              <span>
                                                ,{product.productName}{" "}
                                              </span>
                                  ...
                                  <td className="text-right px-sm-0 text-capitalize">
                                    {StdFunctions.isDepositTransaction(
                                      ...
                                      <h5 className="font-size-14 mb-1 text-success">
                                        {StdFunctions.kenyaCurrency(
                                          transaction.amount
                                        )}
                                      </h5>
                                    ) : (
                                      <h5 className="font-size-14 mb-1 text-danger">
                                        {StdFunctions.kenyaCurrency(
                                          transaction.amount
                                        )}
                                      </h5>
                                    ...
                                    <div className="text-muted">
                                      {Moment(transaction.dateCreated).calendar(
                                        null,
                                        {
                  ...
                  <div className="card-body px-5 d-flex flex-column justify-items-center align-items-center text-center no-trans-cont">
                    <div className="p-5 py-0">
                      <img
                        src="assets/images/illustration-images/empty-transactions.svg"
                        className="img mb-4"
                      />
                    </div>
                    <h4 className="fw-bold">No Transactions Yet</h4>
                    <p>
                      No transactions have been registered with the student, you
                      can start by sending them money first{" "}
                    </p>
                    <a
                      className="font-size-24px d-none"
                      href=""
                      data-bs-toggle="modal"
                      data-bs-target="#walletTopUp"
                    >
                      Send Money
                    </a>
                    <a
              ...
              <div className="card-body">
                ...
                <div className="row">
                        ...
                        <div className="col-auto">
                          <div className="text-capitalize">
                            ...
                            <h4 className="d-flex">
                              ...
                              <div className="font-size-12 mt-1 text-muted">
                  ...
                  <div className="col-lg-6 col-sm-12">
                    <h4 className="card-title font-12px pt-5 mb-0 ">
                      Expenditure By Other Account Types
                    </h4>
                      ...
                      <div className="bg-danger bg-soft px-3 py-2 mb-3 d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          <div className="me-3">
                            <img
                              className="me-2"
                              src="assets/images/blink-accounts/alternate/schoolFees.svg"
                              alt=""
                              height="40px"
                            />
                          </div>
                          <div>
                            <h6 className="mb-0 text-capittalize">
                              School fees
                            </h6>
                      ...
                      <div className="bg-danger bg-soft px-3 py-2 mb-3 d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          <div className="me-3">
                            <img
                              className="me-2"
                              src="assets/images/blink-accounts/alternate/savings.svg"
                              alt=""
                              height="40px"
                            />
                          </div>
                      ...
                      <div className="bg-danger bg-soft px-3 py-2 mb-3 d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          <div className="me-3">
                            <img
                              className="me-2"
                              src="assets/images/blink-accounts/alternate/transport.svg"
                              alt=""
                              height="40px"
                            />
                          </div>
